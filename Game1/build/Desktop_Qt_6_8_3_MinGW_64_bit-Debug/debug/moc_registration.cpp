...
namespace {
struct qt_meta_tag_ZN12RegistrationE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12RegistrationE = QtMocHelpers::stringData(
    "Registration",
    "closeDB",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12RegistrationE[] = {
...
Q_CONSTINIT const QMetaObject Registration::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12RegistrationE.offsetsAndSizes,
    qt_meta_data_ZN12RegistrationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12RegistrationE_t,
        // Q_OBJECT / Q_GADGET
...
void *Registration::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12RegistrationE.stringdata0))
