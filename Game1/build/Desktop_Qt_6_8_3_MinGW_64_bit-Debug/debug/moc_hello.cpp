...
namespace {
struct qt_meta_tag_ZN5HelloE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN5HelloE = QtMocHelpers::stringData(
    "Hello",
...
Q_CONSTINIT static const uint qt_meta_data_ZN5HelloE[] = {
...
Q_CONSTINIT const QMetaObject Hello::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5HelloE.offsetsAndSizes,
    qt_meta_data_ZN5HelloE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5HelloE_t,
        // Q_OBJECT / Q_GADGET
...
void *Hello::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5HelloE.stringdata0))
